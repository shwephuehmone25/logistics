...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light shadow border-top border-5 border-primary sticky-top p-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            ...
            <h4 class="m-0 pe-lg-5 d-none d-lg-block"><i class="fa fa-headphones text-primary me-3"></i>+95912345678</h4>
        </div>
    </nav>
    <!-- Navbar End -->
    ...
    <div class="container-fluid p-0 pb-5">
        <div class="owl-carousel header-carousel position-relative mb-5">
            <div class="owl-carousel-item position-relative">
                <img class="img-fluid" src="img/carousel-1.jpg" alt="logistics">
        ...
        <div class="container py-5">
            <div class="row g-5">
                <div class="col-lg-3 col-md-6">
                    ...
                    <p class="mb-2"><i class="fa fa-map-marker-alt me-3"></i>23 Street, Tamwe, Yangon</p>
                    <p class="mb-2"><i class="fa fa-phone-alt me-3"></i>+95912345678</p>
            ...
            <div class="copyright">
                <div class="row">
                    <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                        &copy; <a class="border-bottom" href="#">Apparition </a>, All Right Reserved.
                    </div>
    ...
    // Check if Owl Carousel is defined
    if ($.fn.owlCarousel) {
        console.log("Owl Carousel plugin is loaded!");
    } else {
        console.log("Owl Carousel plugin is NOT loaded!");
    }
